        ...
        <div class="dash-content">
            <div class="overview">
                ...
                <div class="admin_buttons">
                    ...
                    <form action="generate_reservations.php" method="post">
                    ...
                    <table class="user-table">
                        ...
                        <tbody>
                            ...
                            if (!empty($search)) {
                                ...
                                $query .= " OR visit_date LIKE '%$search%'";
                                $query .= " OR submission_date LIKE '%$search%'";
                            }
                            ...
                            while ($reservation = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td>" . $reservation['visit_date'] . "</td>";
                                echo "<td>" . $reservation['reason_for_visit'] . "</td>";
                                echo "<td>" . $reservation['submission_date'] . "</td>";
                ...
                <div class="pagination">
                    ...
                    // Previous page link
                    if ($page > 1) {
                        echo "<a href='admin_reservations.php?page=" . ($page - 1);
                        if (!empty($search)) {
                            echo "&search=$search";
                        }
                        echo "'>&laquo;</a>";
                    ...
                    for ($i = 1; $i <= $totalPages; $i++) {
                        if ($i == $page) {
                            echo "<a class='active' href='admin_reservations.php?page=$i";
                        } else {
                            echo "<a href='admin_reservations.php?page=$i";
                        }
                        if (!empty($search)) {
                            echo "&search=$search";
                        }
